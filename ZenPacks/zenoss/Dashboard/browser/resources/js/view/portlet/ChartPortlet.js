Ext.define('Zenoss.Dashboard.view.portlet.ChartPortlet', {

    extend: 'Zenoss.Dashboard.view.Portlet',
    alias: 'widget.chartportlet',
    alternateClassName: ['Zenoss.Dashboard.portlets.ChartPortlet'],
    requires: [
        'Ext.data.JsonStore',
    ...
    initComponent: function(){
        ...
        Ext.apply(this, {
            ...
            items: {
                ...
                animate: false,
                shadow: false,
                store: Ext.create('Zenoss.Dashboard.store.ChartStocks', {
